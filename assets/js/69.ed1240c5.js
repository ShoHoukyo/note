...
const setC4Type = function(c4TypeParam) {
  let sanitizedText = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.d)(c4TypeParam, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
...
const setTitle = function(txt) {
  let sanitizedText = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.d)(txt, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  title = sanitizedText;
};
const db = {
  addPersonOrSystem,
  ...
  getConfig: () => (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)().c4,
  clear,
  LINETYPE,
  ARROWTYPE,
  PLACEMENT,
...
function calcC4ShapeTextWH(textType, c4Shape, c4ShapeTextWrap, textConf, textLimitWidth) {
  if (!c4Shape[textType].width) {
    if (c4ShapeTextWrap) {
      c4Shape[textType].text = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.w)(c4Shape[textType].text, textLimitWidth, textConf);
      c4Shape[textType].textLines = c4Shape[textType].text.split(_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.lineBreakRegex).length;
      c4Shape[textType].width = textLimitWidth;
      c4Shape[textType].height = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.j)(c4Shape[textType].text, textConf);
    } else {
      let lines = c4Shape[textType].text.split(_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.lineBreakRegex);
      ...
      for (const line of lines) {
        c4Shape[textType].width = Math.max(
          (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.h)(line, textConf),
          c4Shape[textType].width
        );
        lineHeight = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.j)(line, textConf);
...
const drawBoundary = function(diagram2, boundary, bounds) {
  ...
  let textLimitWidth = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.h)(boundary.label.text, boundaryLabelConf);
...
const drawRels = function(diagram2, rels2, getC4ShapeObj, diagObj) {
  ...
  for (let rel of rels2) {
    ...
    let textLimitWidth = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.h)(rel.label.text, relConf);
    calcC4ShapeTextWH("label", rel, relTextWrap, relConf, textLimitWidth);
    if (rel.techn && rel.techn.text !== "") {
      textLimitWidth = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.h)(rel.techn.text, relConf);
      calcC4ShapeTextWH("techn", rel, relTextWrap, relConf, textLimitWidth);
    }
    if (rel.descr && rel.descr.text !== "") {
      textLimitWidth = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.h)(rel.descr.text, relConf);
...
const draw = function(_text, id, _version, diagObj) {
  conf = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)().c4;
  ...
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`C:${JSON.stringify(conf, null, 2)}`);
  ...
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`models:`, box);
};
const renderer = {
