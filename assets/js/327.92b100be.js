...
let mainBranchName = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)().gitGraph.mainBranchName;
let mainBranchOrder = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)().gitGraph.mainBranchOrder;
let commits = {};
let head = null;
let branchesConfig = {};
...
let seq = 0;
function getId() {
  return (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.x)({ length: 7 });
}
...
const setOptions = function(rawOptString) {
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("options str", rawOptString);
  rawOptString = rawOptString && rawOptString.trim();
  rawOptString = rawOptString || "{}";
  try {
    options = JSON.parse(rawOptString);
  } catch (e) {
    _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while parsing gitGraph options", e.message);
  }
};
...
const commit = function(msg, id, type, tag) {
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Entering commit:", msg, id, type, tag);
  id = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(id, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  msg = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(msg, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  tag = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(tag, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  const commit2 = {
    id: id ? id : seq + "-" + getId(),
    message: msg,
    seq: seq++,
  ...
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in pushCommit " + commit2.id);
};
const branch = function(name, order) {
  name = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(name, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  if (branches[name] === void 0) {
    branches[name] = head != null ? head.id : null;
    branchesConfig[name] = { name, order: order ? parseInt(order, 10) : null };
    checkout(name);
    _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in createBranch");
  } else {
    let error = new Error(
...
const merge = function(otherBranch, custom_id, override_type, custom_tag) {
  otherBranch = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(otherBranch, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  custom_id = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(custom_id, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  ...
  commits[commit2.id] = commit2;
  branches[curBranch] = commit2.id;
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(branches);
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in mergeBranch");
};
const cherryPick = function(sourceId, targetId, tag) {
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Entering cherryPick:", sourceId, targetId, tag);
  sourceId = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(sourceId, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  targetId = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(targetId, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  tag = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(tag, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
  ...
  if (!targetId || commits[targetId] === void 0) {
    ...
    branches[curBranch] = commit2.id;
    _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(branches);
    _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in cherryPick");
  }
};
const checkout = function(branch2) {
  branch2 = _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.e.sanitizeText(branch2, (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)());
...
function prettyPrintCommitHistory(commitArr) {
  ...
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(label.join(" "));
...
const prettyPrint = function() {
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(commits);
...
const clear$1 = function() {
  commits = {};
  head = null;
  let mainBranch = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)().gitGraph.mainBranchName;
  let mainBranchOrder2 = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)().gitGraph.mainBranchOrder;
  branches = {};
...
const getCommitsArray = function() {
  ...
  commitArr.forEach(function(o) {
    _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(o.id);
  });
...
const gitGraphDb = {
  getConfig: () => (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)().gitGraph,
  setDirection,
  setOptions,
  getOptions,
  commit,
...
const drawCommits = (svg, commits2, modifyGraph) => {
  const gitGraphConfig = (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.c)().gitGraph;
...
const draw = function(txt, id, ver, diagObj) {
  ...
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in gitgraph renderer", txt + "\n", "id:", id, ver);
  ...
  _mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.u.insertTitle(
    diagram2,
    "gitTitleText",
    gitGraphConfig.titleTopMargin,
    diagObj.db.getDiagramTitle()
  );
  (0,_mermaid_934d9bea_js__WEBPACK_IMPORTED_MODULE_4__.y)(
    void 0,
    diagram2,
